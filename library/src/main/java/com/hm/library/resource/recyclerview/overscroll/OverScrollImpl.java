package com.hm.library.resource.recyclerview.overscroll;
...
public class OverScrollImpl {
        ...
        try {
            ...
            if (overScrollY != 0) {
                ...
                if (recyclerView.getScrollState() == RecyclerView.SCROLL_STATE_SETTLING) {
                    //TODO improve bounce.
                    if (startOverScrollTime <= 0)
                        startOverScrollTime = System.currentTimeMillis();
    ...
    private void checkBindDataChange() {
        ...
        if (adapter != lastRegAdapter) {
            ...
            if (adapter != null)
                adapter.registerAdapterDataObserver(syncOverScrollWhenDataChange);
